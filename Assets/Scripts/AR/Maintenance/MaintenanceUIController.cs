...
namespace Smartex.AR.Maintenance
{
    ...
    public class MaintenanceUIController : MonoBehaviour
    {
        ...
        void Start()
        {
            // Resolve the maintenance service from the registry (MaintenanceService or MockMaintenanceService registers itself in Awake)
            _maintenanceService = ARServices.Maintenance;
